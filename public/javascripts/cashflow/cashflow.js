...
Камо 💀🐝💀, [04.01.2025 2:20]
/* stylesheet://github.com/orgs/algolia/style#style-sheet-25108-11 */
...
/* https://github.githubassets.com/assets/repos-list.0d146d618a19be14d4b3.module.css */
...
data-color-mode=auto][data-light-theme*=light] {
  ...
  --color-workflow-card-bg: #11aa33aa;
  --color-workflow-card-header-shadow: rgb(4 253 50);
  --color-bg-discussions-row-emoji-box: rgb(2 254 18);
  --color-notifications-row-read-bg: #11aa33aa;
}

/* stylesheet://github.com/orgs/algolia/style#style-sheet-25108-10 */

#tr-popup .tr-popup__input {
  /* border: 2px solid #e5e5e5; */
  border: 2px solid #11aa33aa;
}

Камо 💀🐝💀, [04.01.2025 6:42]
isStorybook (feature-flags.ts:29)
97564 (feature-flags.ts:33)
webpack_require (bootstrap:19)
23780 (ui_packages_failbot_failbot_ts-c551691a8183.js:1)
webpack_require (bootstrap:19)
44045 (environment-7b93e0f0c8ff.js:1)
webpack_require (bootstrap:19)
t (environment-7b93e0f0c8ff.js:1)
(анонимная) (environment-7b93e0f0c8ff.js:1)
s.O (chunk loaded:23)
(анонимная) (environment-7b93e0f0c8ff.js:1)
_ (jsonp chunk loading:71)
(анонимная) (environment-7b93e0f0c8ff.js:1)

Камо 💀🐝💀, [04.01.2025 6:58]
"use strict";
(globalThis.webpackChunk = globalThis.webpackChunk  []).push([["ui_packages_ui-commands_ui-commands_ts"], {
    12480: (e, t, i) => {
        i.d(t, {
            U0: () => a
        });
            ...
            return function() {
                ...
                if (n.cg) {
                    let i = n.cg.navigator
                      , a = i.userAgent
                      , o = i?.userAgentData?.platform  i.platform;
                    -1 !== ["Macintosh", "MacIntel", "MacPPC", "Mac68K", "macOS"].indexOf(o) ? e = s.macOS : -1 !== ["iPhone", "iPad", "iPod"].indexOf(o) ? e = s.iOS : -1 !== ["Win32", "Win64", "Windows", "WinCE"].indexOf(o) ? e = s.Windows : /Android/.test(a) ? e = s.Android : /Linux/.test(o) && (e = s.Linux),
                    t = i?.userAgentData?.mobile ?? (e === s.Android  e === s.iOS)
                }
                return {
                    os: e,
                    isAndroid: e === s.Android,
                    isIOS: e === s.iOS,
                    isMacOS: e === s.macOS,
                    isWindows: e === s.Windows,
                    isLinux: e === s.Linux,
                    isDesktop: e === s.macOS  e === s.Windows  e === s.Linux,
                    isMobile: t
                }
            }().isMacOS
        }
          ...
          , r = e => {
            ...
            n.Vy)(e)
              , i = s() && !function(e) {
                ...
                return ("select" === t  "textarea" === t  "input" === t && !o.has(i)  e.isContentEditable) && !n
            }(e.target);
    ...
    58033: (e, t, i) => {
        ...
        function r() {
            ...
            for (let t of new Set(Array.from(o.values()).flat())) {
                ...
                let n = (0,
                a.fL)(t);
                n && n.defaultBinding && e.get(i)?.commands.push({
                    id: t,
                    name: n.name,
        ...
        let d = e => {
            ...
            n.useId)();
            (0,
            n.useEffect)( () => (o.set(t, s.J.keys(e)),
            () => {
                o.delete(t)
            }
            ), [e, t])
...
line","description":"Start a conversation on the current line"},"react-sandbox:example-command":{"name":"React Sandbox Example Command","description":"Do something.","defaultBinding":"Mod+Shift+Enter"},"sub-issues:add-existing-issue":{"name":"Add existing issue","description":"Add an existing issue as a sub-issue","defaultBinding":"Alt+Shift+A"},"sub-issues:create-sub-issue":{"name":"Create sub-issue","description":"Create a new sub-issue","defaultBinding":"Alt+Shift+C"}}}')
          ...
          , l = e => {
            let t = a[e];
            return !t.featureFlag  (0,
            n.G7)(t.featureFlag.toUpperCase()) ? t : void 0
        }
          , u = e => o[e]
          , c = e => {
            let t = l(e);
            return t?.defaultBinding ? (0,
            s.rd)(t.defaultBinding) : void 0
        }
          , m = e => new Map(e.map(e => [e, c(e)]).filter(e => void 0 !== e[1]))
    }
    ,
    26750: (e, t, i) => {
        i.d(t, {
        ...
        var n, s = i(35311), a = i(89794), o = i(74848), r = i(80497), d = i(96540), l = i(58033);
        let u = new (i(18679)).s({
            ...
            c.send({
                ...
                target_element_html: t.target instanceof HTMLElement ? function(e) {
                    let t = e.tagName.toLowerCase()
                      , i = Array.from(e.attributes).map(e => ${e.name}="${e.value.replaceAll('"', '\\"')}").join(" ");
                    return <${t}${i ?  ${i} : ""}>
                }(t.target) : void 0,
                keybinding: (0,
                a.xJ)(e.commandId)
        ...
        function f(e, t) {
            ...
            d.useEffect)( () => {
                ...
                a.eY)(s.J.keys(t))) {
                    ...
                    t.length && console.warn(The keybinding (${i}) for the "${e}" command conflicts with the keybinding for the already-registered command(s) "${t.join(", ")}". This may result in unpredictable behavior.),
                    n.set(i, t.concat(e))
                }
                return () => {
                    for (let[e,i] of (0,
        ...
        var g = i(18558)
          , v = i(98164);
        function h(e, t, {triggerOnDefaultPrevented: i=!1}={}) {
            let n = (0,
            d.useMemo)( () => new g.KK, [])
              , s = (0,
            d.useMemo)( () => {
...
Камо 💀🐝💀, [04.01.2025 6:58]
if (!i && a.defaultPrevented  o.current === a)
                    return;
                if (o.current = a,
                !(0,
                v.$$)(a)) {
                ...
                let r = s.get(n.sequence) ?? s.get((0,
                g.Vy)(a));
                r && (t(r, a) ?? !0) && (n.reset(),
                e.preventDefault(),
                e.stopPropagation(),
        ...
        let w = "ui-command-trigger"
          , y = ({commands: e}) => {
            ...
            d.useCallback)( () => {
                let e = function() {
                    let e = [...document.querySelectorAll('dialog:modal, [role="dialog"][aria-modal="true"]')].filter(e => e.childNodes.length > 0 && function e(t) {
                        if (t.clientHeight > 0)
                            return !0;
            ...
            d.useEffect)( () => {
                let e = e => {
                    let t = "detail"in e && "object" == typeof e.detail ? e.detail : void 0;
                    if (!t)
                        return;
                    let i = "commandId"in t && "string" == typeof t.commandId && a.dx.is(t.commandId) ? t.commandId : void 0
                      , s = "domEvent"in t && (t.domEvent instanceof KeyboardEvent  t.domEvent instanceof MouseEvent) ? t.domEvent : void 0;
                    i && s && n(i, s)
                }
                ;
        ...
        ;
        try {
            y.displayName  (y.displayName = "GlobalCommands")
        } catch {}
        let b = (0,
        d.createContext)({
        ...
        ;
        try {
            E.displayName  (E.displayName = "CommandKeybindingHint")
        } catch {}
        let C = (0,
        d.forwardRef)( ({commandId: e, children: t, description: i, leadingVisual: n, trailingVisual: s, ...d}, l) => {
...
let u = (0,
            ...
            o.jsxs)(r.l.Item, {
                ...d,
                onSelect: t => c(e, t.nativeEvent),
                ref: l,
                children: [t ?? u.name, i ? (0,
                o.jsx)(r.l.Description, {
                    truncate: !0,
                    children: i
                }) : null, n ? (0,
                o.jsx)(r.l.LeadingVisual, {
                    children: n
                }) : null, null !== s && (0,
                o.jsx)(r.l.TrailingVisual, {
                    children: s ?? (0,
                    o.jsx)(E, {
                        commandId: e,
                        format: "condensed"
        ...
        C.displayName = "ActionList.CommandItem";
        var B = i(55847);
        let I = (0,
        d.forwardRef)( ({commandId: e, children: t, trailingVisual: i, showKeybindingHint: n=!1, keybindingHintVariant: s, onClick: r, ...d}, l) => {
            let u = (0,
            a.fL)(e)
              , {triggerCommand: c} = x();
            if (!u)
            ...
            o.jsx)(B.Q, {
                ...
                onClick: t => {
                    r?.(t),
                    t.defaultPrevented  c(e, t.nativeEvent)
                }
                ,
                trailingVisual: i ?? n ? () => (0,
                o.jsxs)(o.Fragment, {
                    children: [(0,
                    o.jsx)("span", {
                        className: "sr-only",
        ...
        I.displayName = "CommandButton";
        try {
            (n = HintVisual).displayName  (n.displayName = "HintVisual")
        } catch {}
        var M = i(87330);
        let j = (0,
        d.forwardRef)( ({commandId: e, "aria-label": t, onClick: i, ...n}, s) => {
            let r = (0,
            a.fL)(e)
              , {triggerCommand: d} = x();
            return r ? (0,
            o.jsx)(M.K, {
                ...
                onClick: t => {
                    i?.(t),
                    t.defaultPrevented  d(e, t.nativeEvent)
                }
                ,
                ref: s,
                keybindingHint: (0,
        ...
        j.displayName = "CommandIconButton";
        var O = i(98152)
          , q = i(10120)
          , A = i(64515);
        let L = (0,
        d.forwardRef)( ({commands: e, ...t}, i) => {
            let n = (0,
            q.M)(e)
              , a = x()
              , r = (0,
            ...
            d.useState)(new Map)
              , p = (0,
            d.useCallback)( (e, t) => c(i => {

Камо 💀🐝💀, [04.01.2025 6:58]
let n = i.get(e);
                return t.length === n?.length && t.every( (e, t) => n[t] === e) ? i : new Map([...i, [e, t]])
            }
            ), [])
              , g = (0,
            d.useMemo)( () => {
                let t = new Set(Array.from(u.values()).flat());
                return s.J.keys(e).filter(e => !t.has(e))
            }
            , [e, u])
              , v = (0,
            d.useMemo)( () => ({
                triggerCommand: r,
                registerLimitedKeybindingScope: p
            }), [r, p]);
            return (0,
            o.jsx)(k, {
                value: v,
        ...
        let J = (0,
        d.forwardRef)( ({commandIds: e, as: t, triggerOnDefaultPrevented: i, ...n}, s) => {
            let a = h(e, x().triggerCommand, {
                triggerOnDefaultPrevented: i
            })
              , r = (0,
            O._)(a)
              , l = (0,
            ...
            let u = void 0 !== t  void 0 !== n.className ? void 0 : {
                display: "contents"
            };
            return (0,
            o.jsx)(t ?? "div", {
        ...
        J.displayName = "KeyboardScope";
        let N = (0,
        d.forwardRef)( ({commandIds: e, ...t}, i) => {
            let n = x()
              , s = (0,
            d.useId)();
            return (0,
            d.useEffect)( () => n.registerLimitedKeybindingScope(s, e), [n, e, s]),
            (0,
            d.useEffect)( () => () => n.registerLimitedKeybindingScope(s, []), [n, s]),
            (0,
            o.jsx)(J, {
                ref: i,
                commandIds: e,
        ...
        N.displayName = "LimitKeybindingScope";
        let P = Object.assign(L, {
            LimitKeybindingScope: N
        });
        try {
            P.displayName  (P.displayName = "ScopedCommands")
        } catch {}
    }
    ,
    98152: (e, t, i) => {
        ...
        let a = new Set(["enter", "tab"])
          , o = e => {
            ...
            , [])
              , r = (0,
            s.useCallback)(s => {
                if (!a.has(s.key.toLowerCase()) || !t.current) {
                    if ((0,
                    n.U0)() && 229 === s.keyCode && i.current) {
                        i.current = !1;
                        return
                    }
                    e(s)
